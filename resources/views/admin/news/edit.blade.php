							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="">
									<label>
										...
										<input type="radio" name="view_mode" id="view_mode_member" class="flat" value="association" {{ $data['view_mode']=='association'?"checked":"" }}/>&nbsp @lang('news/backend.association')
									</label>
								</div>
							</div>
						</div>
